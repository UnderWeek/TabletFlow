...
- 📐 **Активная область** с визуальным черновиком, точными значениями и проверкой ввода
- ✅ Применение значений области после проверки формата и подтверждение данных, прочитанных обратно из OpenTabletDriver
- ⚙️ **Настройки** внешнего вида, запуска и фонового поведения
...
- предпросмотр на основе текущего черновика
...
- [ ] Прямое перетаскивание и изменение размера в предпросмотре
...
Сейчас приложение включает Обзор, редактирование черновика активной области с проверкой формата и Настройки. Данные планшета и области остаются недоступными, пока их не передаст backend OpenTabletDriver.
